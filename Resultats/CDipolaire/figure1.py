...
ax.text(0.46,0.3,r"$r$",fontsize=25)
ax.text(0.38,0.58,r"${\mathbf{n}}$",fontsize=25)
ax.text(-0.25,0.3,r"${\mathbf{J}}$",fontsize=25)
ax.text(1.05,0.8,r"${\mathbf{S}}$",fontsize=25)


ax.text(-0.35,1.2,r"a",fontweight = 'bold',fontsize=25)
ax.text(-0.8,-0.9,r"b",fontweight = 'bold',fontsize=25)
ax.text(0.8,-0.5,r"c",fontweight = 'bold',fontsize=25)
