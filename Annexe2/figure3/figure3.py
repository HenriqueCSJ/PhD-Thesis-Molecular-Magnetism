execfile("../../old/Transport/CB_classique.py")
fig =figure()
...
arrowpropsleft=dict(arrowstyle='-|>',connectionstyle="arc3,rad=0.5",facecolor="black",linewidth=2)
arrowpropsright=dict(arrowstyle='-|>',connectionstyle="arc3,rad=-0.5",facecolor="black",linewidth=2)

#on dessine le premier diagramme de potentiel chimique
ax.text(-0.6,0.2,"Situation 1",ha="center",va="center",fontsize=25)
ax.plot([-0.89,-0.71],[-0.1,-0.1],'black') #mu source
ax.plot([-0.69,-0.51],[0.,0.],'black') #mu dot
ax.plot([-0.49,-0.31],[-0.1,-0.1],'black') #mu drain
ax.plot(linspace(-0.7,-0.7,10),linspace(-0.3,0.1,10),'black',linestyle='-') #left barrier
ax.plot(linspace(-0.5,-0.5,10),linspace(-0.3,0.1,10),'black',linestyle='-') #right barrier
ax.annotate("",(-0.8,-0.05),(-0.61,0.05),arrowprops=arrowpropsleft)
ax.annotate("",(-0.4,-0.05),(-0.59,0.05),arrowprops=arrowpropsright)


#on dessine le deuxieme diagramme de potentiel chimique
offset1 = 1.2
ax.text(-0.6+offset1,0.2,"Situation 2",ha="center",va="center",fontsize=25)
ax.plot([-0.89+offset1,-0.71+offset1],[-0.1,-0.1],'black') #mu source
ax.plot([-0.69+offset1,-0.51+offset1],[-0.2,-0.2],'black') #mu dot
ax.plot([-0.49+offset1,-0.31+offset1],[-0.1,-0.1],'black') #mu drain
ax.plot(linspace(-0.7+offset1,-0.7+offset1,10),linspace(-0.3,0.1,10),'black',linestyle='-') #left barrier
ax.plot(linspace(-0.5+offset1,-0.5+offset1,10),linspace(-0.3,0.1,10),'black',linestyle='-') #right barrier
ax.annotate("",(-0.61+offset1,-0.15),(-0.8+offset1,-0.05),arrowprops=arrowpropsright)
ax.annotate("",(-0.59+offset1,-0.15),(-0.4+offset1,-0.05),arrowprops=arrowpropsleft)

#on dessine le troisieme diagramme de potentiel chimique
offset1 = 0.6
offset2 = 0.5
ax.text(-0.6+offset1,0.25+offset2+0.05,"Situation 4",ha="center",va="center",fontsize=25)
...
offset1 = 0.6
offset2 = -0.7
ax.text(-0.6+offset1,0.25+offset2+0.05,"Situation 3",ha="center",va="center",fontsize=25)
ax.plot([-0.89+offset1,-0.71+offset1],[-0.1+offset2,-0.1+offset2],'black') #mu source
ax.plot([-0.69+offset1,-0.51+offset1],[0.0+offset2,0.0+offset2],'black') #mu dot
ax.plot([-0.49+offset1,-0.31+offset1],[0.1+offset2,0.1+offset2],'black') #mu drain
ax.plot(linspace(-0.7+offset1,-0.7+offset1,10),linspace(-0.2+offset2,0.2+offset2,10),'black',linestyle='-') #left barrier
...
ax.text(0.7,0.25,r"$\frac{C_{g}}{C_{g}+C_{s}}$",ha="center",va="bottom",fontsize=25,rotation = 0)
################
##plot de droite
...
ax2.set_xlabel(r"$V_{\rm{g}} (u.a.)$")
ax2.set_ylabel(r"$V_{\rm{ds}} (u.a.)$")
