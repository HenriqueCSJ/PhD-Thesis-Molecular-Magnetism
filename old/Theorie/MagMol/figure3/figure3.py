...
ax2.add_patch(r1)
Fe = mpimg.imread("/home/hukadan/These/Manuscript/Theorie/MagMol/figure3/Fe8mol.png")
im = OffsetImage(Fe, zoom=0.25,alpha=0.2)
...
################################
#figure 3.d
Fe = mpimg.imread("/home/hukadan/These/Manuscript/Theorie/MagMol/figure3/Fe8Hysteresismodif.png")
Fe = Fe.tolist()
Fe.reverse()
...
fig.savefig("/home/hukadan/These/Manuscript/Theorie/MagMol/figure3/figure3.pdf")
close(fig)
